...
export function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var error, data, UserModel, searchParams, query, regex, users, users, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!(query.length !== 0 && query)) return [3 /*break*/, 3];
                    regex = new RegExp(query, 'i');
                    return [4 /*yield*/, UserModel.find({ $or: [{ email: regex }, { name: regex }, { description: regex }] })];
                case 2:
                    users = _a.sent();
                    if (!users) {
                        error = true;
