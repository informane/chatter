        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, MessageInstance.findById(id)];
                case 2:
                    user = _a.sent();
                    if (!user) {
...
export function DELETE(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, id, MessageInstance, deletedMessage, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    ...
                    id = searchParams.get('id');
                    MessageInstance = Message;
                    return [4 /*yield*/, MessageInstance.deleteOne({ _id: id })];
                case 2:
                    ...
                    if (!deletedMessage) {
                        ...
                        return [2 /*return*/, new Response(JSON.stringify({ success: true, data: deletedMessage }), { status: 200 })];
                    }
                    return [3 /*break*/, 4];
                case 3:
                    error_2 = _a.sent();
...
export function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, id, body, MessageInstance, message, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
