...
export default function VoipCallDynamic({ status, chatId, userId, userEmail, targetUserEmail }) {
    return (<DynamicVoipCall status={status} chatId={chatId} userId={userId} userEmail={userEmail} targetUserEmail={targetUserEmail}/>);
}
